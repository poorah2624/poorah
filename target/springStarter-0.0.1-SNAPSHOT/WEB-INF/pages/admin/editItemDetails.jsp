        ...
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                  <form action ="view_Item" name="my_form" class="form-horizontal form-label-left" onSubmit="document.my_form.editor_contents.value = $('#editor').html()" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="stock" id="stock" pattern="[0-9]{1,20}" name="price" title="Enter Digits Only" required="required" placeholder="Enter Stock Limit" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                        <div class="form-group">
