					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<c:if test="${not empty Error}">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>View Category <small><a href="/Add_Category"><button class="btn-lg btn btn-outline btn-success">Add Category</button></a></small></h3>
								</div>
								<div class="col-md-6">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="/Edit_Category/${c.categoryId}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                          </td>
                        <td> <a href="/Delete_Category/${c.categoryId}" class="btn btn-danger btn-xs"  onclick="if(confirm('Sure Want?')){return true;} else{return false;};"><i class="fa  fa-trash-o"></i> Delete </a>
                          </td>
