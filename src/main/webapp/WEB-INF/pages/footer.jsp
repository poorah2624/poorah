				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope"
							aria-hidden="true"></i><a href="mailto:info@example.com">${cDetails.emailId }</a></li>
						<li><i class="glyphicon glyphicon-earphone"
							aria-hidden="true"></i>${cDetails.mobileNo }</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Information</h3>
					<ul class="info">
						...
						<li><a href="${pageContext.request.contextPath}/mail">Contact Us</a></li>
						<li><a href="${pageContext.request.contextPath}/faq">FAQ's</a></li>
						<li><a href="${pageContext.request.contextPath}/products2">Special Products</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Category</h3>
			...
			<div class="footer-copy1">
				<div class="footer-copy-pos">
					<a href="#home1" class="scroll"><img
						src="${pageContext.request.contextPath}/uploads/arrow.png" alt=" "
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/bootstrap-3.1.1.min.js"></script>
	<script
