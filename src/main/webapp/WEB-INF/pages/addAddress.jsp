...
<body>
						...
						<form action="/saveAddress" method="post">
							...
							<div class="form-group">
								<label>Full Name</label> <input type="text" name="fullName"
									class="form-control" required placeholder="e.g. John Doe">
							</div>
							...
							<div class="form-group">
								<label>Flat, House no., Building, Company</label> <input
									type="text" name="houseNo" class="form-control" required
									placeholder="House No / Apartment details">
							</div>
							...
							<div class="form-row-custom">
								<div class="form-group">
									<label>Town/City</label> <select name="city" id="addressCity"
										class="form-control" required>
								...
								<div class="form-group">
									<label>State</label> <select name="state" id="addressState"
										class="form-control" required>
							...
							<div class="form-group">
								<label>Pincode</label> <input type="text" name="pincode"
									id="addressPincode" class="form-control" required
									placeholder="6-digit PIN code" maxlength="6"
									onblur="autoFetchLocation()">
							</div>

							<div class="form-group">
								<label>Address Type</label>
								<div class="address-type-group">
									<label> <input type="radio" name="addressType"
										value="Home" checked> <span>🏠 Home</span>
									</label> <label> <input type="radio" name="addressType"
										value="Office"> <span>🏢 Office</span>
									</label> <label> <input type="radio" name="addressType"
										value="Friend"> <span>🙋‍♂️ Friend</span>
									</label>
								</div>
							</div>

							<div class="form-group">
								<label class="default-addr-checkbox"> <input
									type="checkbox" name="isDefaultAddress" value="true">
							...
							<div class="form-actions-row">
								...
								<button type="submit" class="btn-submit-addr">Save
									Address</button>
							</div>
	...
	function autoFetchLocation() {
	    let pincode = document.getElementById("addressPincode").value;
	    if (pincode.length !== 6 || isNaN(pincode)) {
	        return;
	    }

	    let citySelect = document.getElementById("addressCity");
	    let stateSelect = document.getElementById("addressState");
	    ...
	    .then(data => {
	        if (data[0].Status === "Success") {
	            ...
	            let stateName = postOffices[0].State;
	            
	            let uniqueCities = [...new Set(postOffices.map(po => po.District))];
	            ...
	            alert("❌ Invalid Pincode entry or location not found.");
	        }
	    })
	    .catch(err => {
	        console.error(err);
