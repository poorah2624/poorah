...
<style>
    ...
    .size-chart-link:hover { text-decoration: underline !important; }
    ...
    .btn-submit-studio:hover { background: #e68a00; }
    ...
    .btn-pin-check:hover { background: #fff9f2; }
    ...
    <c:if test="${not empty defaultAddress}">
        <div class="container" style="margin-top: 20px; margin-bottom: -10px;">
            <div class="delivery-bar">
                <span><i class="glyphicon glyphicon-map-marker" style="color: #ff9800; margin-right:5px;"></i> 
                Deliver to: <b>${defaultAddress.fullName}, ${defaultAddress.pincode}</b></span>
			...
			<div class="studio-container">
				...
				<div class="preview-canvas-card">
                    ...
                    <div class="tshirt-canvas-wrapper">
						<img src="https://res.cloudinary.com/dqufjiuzx/image/upload/v1776880777/male_wqzxj0.png" class="tshirt-base-img" id="tshirtImage" alt="Tshirt Vector Base"> 
                        <img id="designPreview" class="design-overlay-preview" src="" alt="" style="display: none;"/>
					</div>
				</div>

				<div class="studio-form-card">
					<form action="/addCustomToCart" method="post" enctype="multipart/form-data">
						
						<h3>Create Your Custom T-Shirt 🎨</h3>

						<div class="studio-group">
							<label>Upload Your Design (PNG Format Preferred)</label> 
                            <input type="file" id="designInput" name="image" accept="image/*" class="form-control" required>
						</div>
						...
						<div class="studio-group">
							<label>
                                ...
                                <a href="javascript:void(0);" class="size-chart-link" onclick="openSizeChart()">
                                    <i class="glyphicon glyphicon-th-list"></i> Size Chart
                                </a>
                            </label>
							<div class="size-chips-group">
								<label><input type="radio" name="size" value="S" required><span>S</span></label> 
                                ...
                                <label><input type="radio" name="size" value="XXL"><span>XXL</span></label> 
							</div>
						</div>

						<div class="studio-group">
							<label>Select T-Shirt Base Color</label>
						...
						<div class="studio-group">
							...
							<div class="type-chips-group">
                                <label><input type="radio" name="tshirtType" value="Regular" checked><span>Regular Fit</span></label>
							    <label><input type="radio" name="tshirtType" value="Oversize"><span>Oversize Fit</span></label>
                            </div>
						</div>

                        <div class="studio-group">
							<label>Custom Instructions / Special Note (Optional)</label>
							<textarea name="customNote" class="form-control" placeholder="Tell us if you want the design on the back, custom size placement or print details..."></textarea>
						</div>
						...
						<div class="studio-price-block">
                            ...
                            <button type="submit" class="btn-submit-studio">Add Custom T-Shirt to Cart</button>

                            <div style="margin-top: 25px; border-top: 1px solid #eaeaea; padding-top: 20px;">
                                <label style="font-size:12px; font-weight:700; color:#666; display:block; margin-bottom:8px;">Check Delivery Availability</label>
								<div class="pin-checker-row">
                                    <input type="text" id="pincode" placeholder="Enter 6-digit Pincode" class="form-control" style="max-width: 220px;" maxlength="6"/>
								    <button type="button" onclick="checkDelivery()" class="btn-pin-check">Check</button>
                                </div>
								<i id="deliveryResult" style="display:block; margin-top: 10px; font-size:13px; font-weight:600; color: green;"></i>
							</div>
						</div>
