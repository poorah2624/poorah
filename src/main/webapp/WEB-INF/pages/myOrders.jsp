		...
		<div class="container">
				...
				<c:otherwise>
					<c:forEach var="order" items="${orders}">
						...
						<div
							...
							<c:forEach var="item" items="${order.items}">
								...
								<div
									...
									<!-- PRODUCT IMAGE -->
									<img
										src="${pageContext.request.contextPath}/uploads/${fn:split(item.item.itemImage, ',')[0]}"
                                   ...
                                   <p style="margin: 5px 0;">Size : ${item.size}</p>
									...
									<div style="margin-bottom: 15px;">
										<a
											href="${pageContext.request.contextPath}/order/details?orderItemId=${item.id}">
						...
						<c:if
							...
							<form method="post"
								action="${pageContext.request.contextPath}/order/cancel-item">
						...
						<c:if
							...
							<form action="${pageContext.request.contextPath}/order/revert-cancel" method="post">
								<input type="hidden" name="orderItemId" value="${item.id}">
						...
						<c:if
							...
							<form action="${pageContext.request.contextPath}/order/revert-return" method="post">
								<input type="hidden" name="orderItemId" value="${item.id}">
						...
						<c:if
							...
							<form action="${pageContext.request.contextPath}/order/revert-exchange" method="post">
								<input type="hidden" name="orderItemId" value="${item.id}">
			...
			<div id="exchangeModal"
				...
				<div
					...
					<form method="post"
						action="${pageContext.request.contextPath}/order/exchange">
