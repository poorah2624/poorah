			...
			<div class="navigation">
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header nav_2">
						<a href="/home" class="mobile-brand-logo-link">
							<img src="https://res.cloudinary.com/dqufjiuzx/image/upload/v1776880803/brand_image_t93n6o.png" alt="PooRah Logo" class="mobile-brand-logo">
						</a>
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							<li class="desktop-logo-item">
								<a href="/home" style="padding: 10px 15px;">
									<img src="https://res.cloudinary.com/dqufjiuzx/image/upload/v1776880803/brand_image_t93n6o.png" alt="PooRah Logo" class="site-logo">
								</a>
							</li>
							<li class="active"><a href="/home" class="act">Home</a></li>

							<c:forEach var="cat" items="${categories}">
								<li class="dropdown mobile-category">
									<a href="/products3/category/${cat.categoryId}" class="category-link">${cat.categoryName}</a>
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown" style="position: relative;">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> Hi, ${sessionScope.LoggedInUser.userName} <span class="caret"></span></a>
