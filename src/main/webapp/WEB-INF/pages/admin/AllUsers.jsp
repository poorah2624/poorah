					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Users <small><a href="/allUsersTable"><button class="btn-lg btn btn-outline btn-success">Table View</button></a></small></h3>
								</div>
								<div class="col-md-6">
                   ...
                   <div class="col-md-4 col-sm-6 col-xs-12 animated fadeInDown">
                      <div class="well profile_view" >
                        ...
                        <div class="col-xs-12 bottom text-center">
                          ...
                          <div class="col-xs-12 col-sm-6 emphasis">
                              <a href="/ReplyQuery" ><button type="button" class="btn btn-success btn-xs"> <i class="fa fa-user">
