					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Users <small><a href="${pageContext.request.contextPath}/allUsersTable"><button class="btn-lg btn btn-outline btn-success">Table View</button></a></small></h3>
								</div>
								<div class="col-md-6">
                   ...
                   <div class="col-md-4 col-sm-6 col-xs-12 animated fadeInDown">
                      <div class="well profile_view" >
                        <div class="col-sm-12" style = "height:200px;">
                          <!--  <h4 class="brief"><i>Full Stack Developer</i></h4>-->
                          <div class="left col-xs-7">
                            <h2>${u.userName }</h2>
                            <!--  <p><strong>About: </strong> Web Developer / UI. </p>-->
                            <ul class="list-unstyled">
                            <c:forEach var="addr" items="${u.addresses}">
                                <li><i class="fa fa-book"></i> Address:<strong>${addr.houseNo}, ${addr.area}, ${addr.city}, ${addr.state} - ${addr.pincode}</strong> </li>
                                </c:forEach>
                                <li><i class="fa fa-phone"></i> Mobile:<strong>${u.userMobile }</strong> </li>
                                 <li><i class="fa fa-shopping-cart"></i> Orders:<strong>${u.orders }</strong> </li>
                                <li><i class="fa fa-calendar"></i> Registered date:</br><strong>${u.createdAt }</strong> </li>
                            </ul>
                          </div>
                        ...
                        <div class="col-xs-12 bottom text-center">
                          ...
                          <div class="col-xs-12 col-sm-6 emphasis">
                              <a href="${pageContext.request.contextPath}/ReplyQuery" ><button type="button" class="btn btn-success btn-xs"> <i class="fa fa-user">
