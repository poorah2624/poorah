			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Gallery <small><a href="${pageContext.request.contextPath}/view_Gallery"><button class="btn-lg btn btn-outline btn-success">View Gallery</button></a></small></h3>
								</div>
								<div class="col-md-6">
             ...
             <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form action ="${pageContext.request.contextPath}/edit_Gallery" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="Multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" id="file" name="image" value="${gallery.galleryName}" class="form-control col-md-7 col-xs-12" onchange="return fileValidation()">
                      </div>
                    </div>
                      <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div id="status" class="btn-group" data-toggle="buttons">
                          <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                            <input type="radio" name="galleryStatus" value="${gallery.galleryStatus}"> &nbsp; Active &nbsp;
                          </label>
                          <label class="btn btn-primary active" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="galleryStatus" value="${gallery.galleryStatus}" checked=""> In-Active
                          </label>
                        </div>
                      </div>
                    </div>
