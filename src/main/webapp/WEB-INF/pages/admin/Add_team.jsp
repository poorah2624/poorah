		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Add Team <small><a href="${pageContext.request.contextPath}/View_team"><button class="btn-lg btn btn-outline btn-success">View Team</button></a></small></h3>
								</div>
								<div class="col-md-6">
             ...
             <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form action ="${pageContext.request.contextPath}/save" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" id="file" name="file" required="required" class="form-control col-md-7 col-xs-12" onchange="return fileValidation()">
                      </div>
                    </div>
                      <div class="item form-group">
