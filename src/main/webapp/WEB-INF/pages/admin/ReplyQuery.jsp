		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
             ...
             <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form action ="${pageContext.request.contextPath}/ReplyQuery" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="to" name="userName" required="required" value="${contact.userName }" readonly="" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                     <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="to">To <span class="required">*</span>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="to" name="userEmail" required="required" value="${contact.userEmail }" readonly="" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" required="required" name="subject" placeholder="Subject" value="Reply To Your Query" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
