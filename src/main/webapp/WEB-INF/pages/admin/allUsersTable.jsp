											...
											<tbody>
												<c:forEach var="u" items="${users}">
													<tr>
														...
														<td>${u.userEmail }</td>
														<td>${u.userMobile }</td>
														<td><c:forEach var="addr" items="${u.addresses}">
                                                     ${addr.houseNo}, ${addr.area}, ${addr.city}, ${addr.state} - ${addr.pincode} <br>
															</c:forEach></td>
															<td>${u.orders }</td>
															<td>${u.createdAt }</td>
														<td><a
															href="${pageContext.request.contextPath}/Edit_Category"
															class="btn btn-success btn-xs"><i
																class="fa fa-pencil"></i> Active </a></td>
