	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Edit Instagram <small><a href="${pageContext.request.contextPath}/view_insta"><button class="btn-lg btn btn-outline btn-success">View Category</button></a></small></h3>
								</div>
								<div class="col-md-6">
             ...
             <div class="x_panel">
                <div class="x_title">
                  <h2>Edit Instagram <small>Here</small></h2>
                ...
                <div class="x_content">
                  <br />
                  <form action ="${pageContext.request.contextPath}/edit_insta" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                   
                    <input type="hidden" name="instaId" value="${social.instaId }">
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Platform <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" pattern="([A-Za-z .])+" name="platform" value="${social.platform }" title="Enter Words Only" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" name="url" value="${social.url }" title="Enter url Only" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div id="status" class="btn-group" data-toggle="buttons">
                          <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                            <input type="radio" name="categoryStatus" value="${socialLinks.socialStatus }"> &nbsp; Active &nbsp;
                          </label>
                          <label class="btn btn-primary active" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="categoryStatus" value="${category.socialStatus }" checked="" required=""> In-Active
                          </label>
                        </div>
                      </div>
                    </div>
