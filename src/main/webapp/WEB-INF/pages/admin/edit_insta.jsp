					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										Edit Instagram <small><a href="/view_insta"><button
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Edit Instagram <small>Here</small>
									</h2>
								...
								<div class="x_content">
									<br />
									<form action="/edit_insta" method="post" id="demo-form2"
										data-parsley-validate class="form-horizontal form-label-left">

										<input type="hidden" name="instaId" value="${social.instaId }">
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="title">Platform <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" id="title" pattern="([A-Za-z .])+"
													name="platform" value="${social.platform }"
													title="Enter Words Only" required="required"
													class="form-control col-md-7 col-xs-12">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="title">Url <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" id="title" name="url"
													value="${social.url }" title="Enter url Only"
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12">Status
												*</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<!-- Strict name attribute matching the model property -->
												<select name="socialStatus" class="form-control" required>
													<option value="active"
														${social.socialStatus == 'active' ? 'selected' : ''}>Active</option>
													<option value="inactive"
														${social.socialStatus == 'inactive' ? 'selected' : ''}>Inactive</option>
												</select>
											</div>
										</div>
