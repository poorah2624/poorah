													...
													<tr>
														...
														<td>
															<div class="left">
																...
																<c:choose>
																	<c:when test="${cont.status == 'NEW'}">
																		<a
																	href="" class="btn btn-success"> Not Replied</a>
																	</c:when>
														...
														<td>
															<div class="right">
																<h3>${cont.userName }<br> <small>${cont.createdAt.toString().replace('T',' ')}</small>
																</h3>
																<p>${cont.message }</p>
															</div>
														</td>
														<td>${cont.userEmail }</td>
														<td><a
															href="${pageContext.request.contextPath}/ViewContactQuery/${cont.contactId}"><i
