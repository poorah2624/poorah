					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Admin Panel <small><a href="${pageContext.request.contextPath}/AddPin"><button class="btn-lg btn btn-outline btn-success">Add Pin</button></a></small></h3>
								</div>
								<div class="col-md-6">
                ...
                <div class="x_content">
                 ...
                 <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>${p.pincode }</td>
                            <td><a href="${pageContext.request.contextPath}/editPin/${p.pinId }" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a></td>
                            <td><a href="${pageContext.request.contextPath}/DeletePin/${p.pinId }" class="btn btn-danger btn-xs" onclick="if(confirm('Sure Want?')){return true;} else{return false;};"><i class="fa  fa-trash-o"></i> Delete </a></td>
                        </tr>
                       </c:forEach>
