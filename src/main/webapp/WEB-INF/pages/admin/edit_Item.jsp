			...
			$("#addVariantBtn").click(function(){
				$("#variantContainer").append(`
					<div class="colorBlock" style="border:1px solid #ddd; padding:15px; margin-bottom:15px; border-radius:5px; background:#fafafa;">
						...
						<div>
							<label>S</label>
							<input type="number" name="stockS[]" class="form-control" value="0" min="0">
						</div>
						<div>
							<label>M</label>
							<input type="number" name="stockM[]" class="form-control" value="0" min="0">
						</div>
						<div>
							<label>L</label>
							<input type="number" name="stockL[]" class="form-control" value="0" min="0">
						</div>
						<div>
							<label>XL</label>
							<input type="number" name="stockXL[]" class="form-control" value="0" min="0">
						</div>
