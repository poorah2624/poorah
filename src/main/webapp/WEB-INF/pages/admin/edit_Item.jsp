						...
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										View Items<small><a
											href="${pageContext.request.contextPath}/view_Item"><button
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									...
									<div class="x_content">
										...
										<form action="${pageContext.request.contextPath}/edit_Item"
							...
							if (categoryId != "") {
								...
								$
										.ajax({
											...
											url : "${pageContext.request.contextPath}/getSubCategories",
											type : "GET",
											data : {
