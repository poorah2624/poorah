	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Contact Details <small><a href="${pageContext.request.contextPath}/view_Banner"><button class="btn-lg btn btn-outline btn-success">View Banner</button></a></small></h3>
								</div>
								<div class="col-md-6">
             ...
             <div class="x_panel">
                <div class="x_title">
                  <h2>Edit Contact Details <small>Here</small></h2>
                ...
                <div class="x_content">
                  <br />
                  <form action ="${pageContext.request.contextPath}/editDetails" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      
                      <input type="hidden" name="detailsId" value="${cDetails.detailsId }">
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12"  for="last-name">Email <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="emailId" id="telephone" value="${cDetails.emailId }" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="mobileNo" id="telephone" pattern="[6-9][0-9]{9}" value="${cDetails.mobileNo }" data-validate-length-range="10" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="phone" id="telephone" value="${cDetails.phone }" data-validate-length-range="10" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="facebook" value="${cDetails.facebook }" class="form-control">
                      </div>
                    </div>
                      <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="twitter" value="${cDetails.twitter }" class="form-control">
                      </div>
                    </div>
                      <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="google" value="${cDetails.google }" class="form-control">
                      </div>
                    </div>
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12"  for="last-name">Pinterest <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="pinterest" value="${cDetails.pinterest }" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="address" class="form-control">${cDetails.address }</textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea name="map" class="form-control">${cDetails.map }</textarea>
                      </div>
                    </div>
                    <div class="container">
