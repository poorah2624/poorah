                        ...
                        <div class="mail_heading row">
                          <div class="col-md-8">
                            ...
                            <div class="compose-btn">
                              <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/ReplyQuery/${contact.contactId}"><i class="fa fa-reply"></i> Reply</a>
                          ...
                          <div class="col-md-4 text-right">
                            <p class="date"> ${contact.createdAt.toString().replace('T',' ')}</p>
                          </div>
                          <div class="col-md-12">
                        ...
                        <div class="sender-info">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <span>(${contact.userEmail })</span> to
                              <strong>me</strong>
