					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										Sub-Category <small><a
											href="${pageContext.request.contextPath}/view_SubCategory"><button
													class="btn-lg btn btn-outline btn-success">View
													Sub-Category</button></a></small>
									</h3>
								</div>
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Add Sub-Category <small>Here</small>
									</h2>
								...
								<div class="x_content">
									<br />
									<form
										action="${pageContext.request.contextPath}/edit_SubCategory"
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="title">Select Category <span class="required">*</span>
											</label>
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="title"> Sub-Category <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" id="title" pattern="([A-Za-z .])+"
													name="subCategoryName" title="Enter Words Only"
													required="required" value="${subCategory.subCategoryName }"
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<div id="status" class="btn-group" data-toggle="buttons">
													<label class="btn btn-default"
														...
														type="radio" name="subCategoryStatus"
														value="Active" ${subcategory.subCategoryStatus=='active'?'checked':''}>
														&nbsp; Active &nbsp;
													</label> <label class="btn btn-primary active"
														data-toggle-class="btn-primary"
														data-toggle-passive-class="btn-default"> <input
														type="radio" name="subCategoryStatus"
														value="In-Active" ${subcategory.subCategoryStatus=='inactive'?'checked':''}
														checked="" required=""> In-Active
													</label>
												</div>
											</div>
										</div>
