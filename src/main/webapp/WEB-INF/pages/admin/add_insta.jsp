					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<c:if test="${not empty Error}">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										Instagram <small><a href="${pageContext.request.contextPath}/view_insta"><button
													class="btn-lg btn btn-outline btn-success">View
													Instagram</button></a></small>
									</h3>
								</div>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="${pageContext.request.contextPath}/add_insta"
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" id="title" pattern="([A-Za-z .])+"
													name="platform" title="Enter Words Only"
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="title">Instagram link <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" id="title"
													name="url" title="Enter Words Only"
													required="required" placeholder="Enter Title here"
													class="form-control col-md-7 col-xs-12">
											</div>
										</div>
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<div id="status" class="btn-group" data-toggle="buttons">
													<label class="btn btn-default"
														...
														type="radio" name="socialStatus" value="active">
														&nbsp; Active &nbsp;
													</label> <label class="btn btn-primary active"
														data-toggle-class="btn-primary"
														data-toggle-passive-class="btn-default"> <input
														type="radio" name="socialStatus" value="inactive"
