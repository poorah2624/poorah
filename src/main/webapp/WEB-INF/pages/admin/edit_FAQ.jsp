		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
             ...
             <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form action ="${pageContext.request.contextPath}/edit_FAQ" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" required="required" name="question" value="${faq.question }" placeholder="Enter Question here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
