						...
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										Banner <small><a
											href="${pageContext.request.contextPath}/Add_Banner"><button
													...
													<div class="thumbnail">
														<div class="image view view-first">
															...
															<img style="width: 100%; display: block;"
																src="${pageContext.request.contextPath}/uploads/${b.bannerName}"
																alt="image" />
															<div class="mask">
																<p>${b.bannerStatus}</p>
																...
																<div class="tools tools-bottom">
																	<a
																		href="${pageContext.request.contextPath}/edit_Banner/${b.bannerId}"
																		data-toggle="tooltip" title="Edit Banner"><i
																		class="fa fa-pencil"></i></a> <a
																		href="${pageContext.request.contextPath}/delete_Banner/${b.bannerId}"
