	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Edit Item Image <small><a href="edit_Item.jsp"><button class="btn-lg btn btn-outline btn-success">Go Back</button></a></small></h3>
								</div>
								<div class="col-md-6">
             ...
             <div class="x_panel">
                <div class="x_title">
                  <h2>Edit Item Image <small>Here</small></h2>
                ...
                <div class="x_content">
                  <br />
                  <form action ="view_Gallery" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="Multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12"  for="last-name">Image Upload <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
