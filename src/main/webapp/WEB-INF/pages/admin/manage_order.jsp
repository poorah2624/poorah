														...
														<tr>
															...
															<c:choose>
																<c:when test="${item.isCustom}">
																	<td><img
																		src="${pageContext.request.contextPath}/uploads/${fn:split(item.customImage, ',')[0]}"
																		style="width: 60px; height: 70px; border-radius: 5px;" />
																		<a
																		href="${pageContext.request.contextPath}/uploads/${item.customImage}"
															...
															<td><a
																href="${pageContext.request.contextPath}/updateOrder?id=${o.id}"
