                  ...
                  <form action ="${pageContext.request.contextPath}/editTeam" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="Multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" pattern="([A-Za-z .])+" name="tName" value="${team.tName }" title="Enter Words Only" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="email" name="tEmail" value="${team.tEmail }" required="required" class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="des" pattern="([A-Za-z .])+" name="tDesignation" value="${team.tDesignation }" title="Enter Words Only" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" id="file" name="file" value="${team.tImage }" class="form-control col-md-7 col-xs-12" onchange="return fileValidation()">
                      </div>
                    </div>
                      <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="tel" id="telephone" name="tMobile" value="${team.tMobile }" data-validate-length-range="10" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
