		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
                ...
                <div class="x_content">
                  ...
                  <form action="${pageContext.request.contextPath}/editPin" method="post" class="form-horizontal form-label-left" novalidate>
                    ...
                    <div class="form-group">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                <td>Pin</td>
                                <input type="hidden" name="pinId" value="${pin.pinId }">
                                <td><input type="text" name="pincode" value="${pin.pincode }" pattern="[0-9]{6}" class="form-control"></td>
                            </tr>
