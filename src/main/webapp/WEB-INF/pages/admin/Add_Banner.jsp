		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
             ...
             <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" action="${pageContext.request.contextPath}/Add_Banner" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
