					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>View Team <small><a href="/Add_team"><button class="btn-lg btn btn-outline btn-success">Add Team</button></a></small></h3>
								</div>
								<div class="col-md-6">
                   ...
                   <c:forEach var="t" items="${teams}">
                      ...
                      <div class="well profile_view">
                        ...
                        <div class="col-xs-12 bottom text-center">
                            <a href="/DeleteTeam/${t.teamId }" onclick="if(confirm('Sure Want?')){return true;} else{return false;};">  <button type="button" class="btn btn-danger btn-sm btn-round"> <i class="fa fa-user">
                                 </i> Delete </button> </a>
                       
                          <div class="col-xs-12 col-sm-6 emphasis">
                              <a href="/editTeam/${t.teamId }" ><button type="button" class="btn btn-round btn-success btn-sm"> <i class="fa fa-user">
