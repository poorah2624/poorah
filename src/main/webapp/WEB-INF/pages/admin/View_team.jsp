					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>View Team <small><a href="${pageContext.request.contextPath}/Add_team"><button class="btn-lg btn btn-outline btn-success">Add Team</button></a></small></h3>
								</div>
								<div class="col-md-6">
                  ...
                  <br />
                   ...
                   <c:forEach var="t" items="${teams}">
                      ...
                      <div class="well profile_view">
                        ...
                        <div class="col-sm-12">
                          <h4 class="brief"><i>${t.tDesignation }</i></h4>
                          <div class="left col-xs-7">
                              <h2><strong>${t.tName }</strong></h2>
                            <p><strong>About: </strong> ${t.tDesignation } </p>
                           
                          </div>
                          <div class="right col-xs-5 text-center">
                            <img src="${pageContext.request.contextPath}/uploads/${t.tImage }" alt="" class="img-circle img-responsive team-img" style="width: 120px;height: 120px;object-fit: cover;border-radius: 50%;">
                          </div>
                        </div>
                        <div class="col-xs-12 bottom text-center">
                            <a href="${pageContext.request.contextPath}/DeleteTeam/${t.teamId }" onclick="if(confirm('Sure Want?')){return true;} else{return false;};">  <button type="button" class="btn btn-danger btn-sm btn-round"> <i class="fa fa-user">
                                 </i> Delete </button> </a>
                       
                          <div class="col-xs-12 col-sm-6 emphasis">
                              <a href="${pageContext.request.contextPath}/editTeam/${t.teamId }" ><button type="button" class="btn btn-round btn-success btn-sm"> <i class="fa fa-user">
