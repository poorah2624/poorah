		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Admin Panel <small><a href="${pageContext.request.contextPath}/dashboard"><button class="btn-lg btn btn-outline btn-success">Go To DashBoard</button></a></small></h3>
								</div>
								<div class="col-md-6">
                ...
                <div class="x_content">
                  ...
                  <form action="${pageContext.request.contextPath}/change_Password" method="post" class="form-horizontal form-label-left" novalidate>
