						...
						<div class="dashboard_graph">
							...
							<div class="row tile_count">
								...
								<!--  <div
									...
									<div class="left"></div>
									<div class="right">
										<a href="AllVendors.jsp" class="btn btn-primary btn-round">
								...
								<div
									...
									<div class="left"></div>
									<div class="right">
										<a href="view_subadmin.jsp" class="btn  btn-round "
											style="background-color: #330033; color: white"> <span
											class="count_top"><i class="fa fa-user"></i> Sub-Admin</span></a>
								...
								<!--  <div
									...
									<div class="right">
										<a href="view_Subscription.jsp"
											class="btn btn-warning btn-round"><span
											class="count_top"><i class="fa fa-user"></i>
												Subscription Request</span></a>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
										...
										<h3>${sessionScope.LoggedInAdmin.name}</h3>

										<ul class="list-unstyled user_data">
											<li><i class="fa fa-map-marker user-profile-icon"></i>
												${sessionScope.LoggedInAdmin.address}</li>

											<!-- <li>
                        <i class="fa fa-briefcase user-profile-icon"></i> Destination
                      </li>
