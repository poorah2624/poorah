					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<c:if test="${not empty Error}">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										Category <small><a href="${pageContext.request.contextPath}/view_Category"><button
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="${pageContext.request.contextPath}/Add_Category"
										method="post" id="demo-form2" data-parsley-validate
										class="form-horizontal form-label-left">

										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="title">Add Category <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" id="title" pattern="([A-Za-z .])+"
													name="categoryName" title="Enter Words Only"
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<div id="status" class="btn-group" data-toggle="buttons">
													<label class="btn btn-default"
														...
														type="radio" name="categoryStatus" value="active">
														&nbsp; Active &nbsp;
													</label> <label class="btn btn-primary active"
														data-toggle-class="btn-primary"
														data-toggle-passive-class="btn-default"> <input
														type="radio" name="categoryStatus" value="inactive"
