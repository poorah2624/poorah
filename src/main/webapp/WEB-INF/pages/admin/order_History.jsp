                    ...
                    <tbody>
                      ...
                      src="${pageContext.request.contextPath}/uploads/${fn:split(item.item.itemImage, ',')[0]}"
                        ...
                        <td>${o.status }</td>
                          ...
                          <td><a href="${pageContext.request.contextPath}/updateOrder?id=${o.id}" class="btn btn-primary">Update</a></td>
                          <td><a href="${pageContext.request.contextPath}/invoice" class="btn btn-xs btn-info fa fa-book"> View</a></td>
                      </tr>
                      </c:forEach>
                      </c:forEach>
