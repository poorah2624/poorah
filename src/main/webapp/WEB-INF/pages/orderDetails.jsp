      ...
      item.order.status == 'Pending' ? 'orange' : 'red'};">
            ...
            ${item.order.status}
						...
						<c:if
							...
							<form
								action="${pageContext.request.contextPath}/order/revert-cancel"
								method="post">
								<input type="hidden" name="orderItemId" value="${item.id}">
								<button
						...
						<c:if
							...
							<form
								action="${pageContext.request.contextPath}/order/revert-return"
								method="post">
								<input type="hidden" name="orderItemId" value="${item.id}">
								<button
						...
						<c:if
							...
							<form
								action="${pageContext.request.contextPath}/order/revert-exchange"
								method="post">
								<input type="hidden" name="orderItemId" value="${item.id}">
								<button
				...
				<div style="margin-top: 20px;">
					...
					<div style="margin-top: 15px;">
						<a
							href="${pageContext.request.contextPath}/order/invoice/${item.id}"
